...
write.csv(epl_data, "epl_data.csv")
write.csv(bun_data, "bun_data.csv")
write.csv(ser_data, "ser_data.csv")
```
...
plot(epl_data$SDPoints, epl_data$Attendance, ylim = c(33000, 39000), xlim = c(12,22), main = "EPL SD of Team Points vs. Attendance, 2009-10 to 2018-19")
abline(fit)
...
plot(epl_data$OddsHome, epl_data$Attendance, ylim = c(33000, 39000), xlim = c(2.5, 3.2), main = "EPL Home Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Home Team Odds", ylab = "Attendance")
abline(fit)
...
plot(epl_data$OddsFavorite, epl_data$Attendance, ylim = c(33000, 39000), xlim = c(1.4, 2.4), main = "EPL Favorite Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Favored Team Odds", ylab = "Attendance")
abline(fit)
...
plot(epl_data$OddsUnderdog, epl_data$Attendance, ylim = c(33000, 39000), xlim = c(4.5, 7))
abline(fit)
...
plot(epl_data$Differential, epl_data$Attendance, ylim = c(33000, 39000), xlim = c(2.5, 5), main = "EPL Odds Differential vs. Attendance, 2008-09 to 2018-19", xlab = "Odds Difference", ylab = "Attendance")
abline(fit)
...
```{r, eval=TRUE}
bun_data <- read.csv("bun_data.csv")
fit <- lm(bun_data$Attendance ~ bun_data$SDPoints)
plot(bun_data$SDPoints, bun_data$Attendance, ylim = c(41000, 46000), xlim = c(12, 18), main = "Bundesliga SD of Points vs. Attendance, 2008-09 to 2018-19", xlab = "SD of Points", ylab = "Attendance")
abline(fit)
...
plot(bun_data$OddsHome, bun_data$Attendance, ylim = c(41000, 46000), xlim = c(2.3, 3.0), main = "Bundesliga Home Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Home Team Odds", ylab = "Attendance")
abline(fit)
...
plot(bun_data$OddsFavorite, bun_data$Attendance, ylim = c(41000, 46000), xlim = c(1.4, 2.4), main = "Bundesliga Favorite Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Favored Team Odds", ylab = "Attendance")
abline(fit)
...
plot(bun_data$OddsUnderdog, bun_data$Attendance, ylim = c(41000, 46000), xlim = c(4.5, 6.0), main = "Bundesliga Underdog Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Underdog Odds", ylab = "Attendance")
abline(fit)
...
plot(bun_data$Differential, bun_data$Attendance, ylim = c(41000, 46000), xlim = c(2, 4), main = "Bundesliga Difference in Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Difference in Odds", ylab = "Attendance")
abline(fit)
...
```{r, eval=TRUE}
ser_data <- read.csv("ser_data.csv")
fit <- lm(ser_data$Attendance ~ ser_data$SDPoints)
plot(ser_data$SDPoints, ser_data$Attendance, ylim = c(22000, 26000), xlim = c(14,21), main = "Serie A SD of Points vs. Attendance, 2008-09 to 2018-19", xlab = "SD of Points", ylab = "Attendance")
abline(fit)
...
plot(ser_data$OddsHome, ser_data$Attendance, ylim = c(22000, 26000), xlim = c(2.2, 3.2), main = "Serie A Home Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Home Team Odds", ylab = "Attendance")
abline(fit)
...
plot(ser_data$OddsFavorite, ser_data$Attendance, ylim = c(22000, 26000), xlim = c(1.4, 2.4), main = "Serie A Favorite Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Favored Team Odds", ylab = "Attendance")
abline(fit)
...
plot(ser_data$OddsUnderdog, ser_data$Attendance, ylim = c(22000, 26000), xlim = c(4.5, 6.9), main = "Serie A Underdog Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Underdog Odds", ylab = "Attendance")
abline(fit)
...
plot(ser_data$Differential, ser_data$Attendance, ylim = c(22000, 26000), xlim = c(2.75, 4.75), main = "Serie A Difference in Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Difference in Odds", ylab = "Attendance")
abline(fit)
...
write.csv(afl_data, "afl_data.csv")
```
...
```{r, eval=TRUE}
afl_data <- read.csv("afl_data.csv")
fit <- lm(afl_data$Attendance~afl_data$SDPoints)
plot(afl_data$SDPoints, afl_data$Attendance, ylim = c(31000, 40000), xlim = c(13,23), main = "AFL SD of Points vs. Attendance, 2008-09 to 2018-19", xlab = "SD of Points", ylab = "Attendance")
abline(fit)
...
plot(afl_data$OddsHome, afl_data$Attendance, ylim = c(31000, 40000), xlim = c(1.8,3.2), main = "AFL Home Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Home Team Odds", ylab = "Attendance")
abline(fit)
...
plot(afl_data$OddsFavorite, afl_data$Attendance, ylim = c(31000, 40000), xlim = c(1.25,1.5), main = "AFL Favorite Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Favored Team Odds", ylab = "Attendance")
abline(fit)
...
plot(afl_data$OddsUnderdog, afl_data$Attendance, ylim = c(31000, 40000), xlim = c(3.25,6.25), main = "AFL Underdog Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Underdog Odds", ylab = "Attendance")
abline(fit)
...
plot(afl_data$Differential, afl_data$Attendance, ylim = c(31000, 40000), xlim = c(2,5), main = "AFL Difference in Odds vs. Attendance, 2008-09 to 2018-19", xlab = "Difference in Odds", ylab = "Attendance")
abline(fit)
