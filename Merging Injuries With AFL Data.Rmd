...
injuries$top5 <- as.numeric(injuries$ave_rating >= quantiles[20])
injuries$top10 <- as.numeric(injuries$ave_rating >= quantiles[19])
injuries$top25 <- as.numeric(injuries$ave_rating >= quantiles[16])
injuries$top50 <- as.numeric(injuries$ave_rating >= quantiles[11])
injuries$all <- as.numeric(injuries$ave_rating >= quantiles[1])
...
injuries$firstname.x <- NULL
injuries$lastname <- NULL
injuries$ave_rating <- NULL
...
colnames(afl) <- c("Round", "Day", "Date", "Year", "Time", "Home", "Away", "Attendance", "Venue", "Home.Odds", "Away.Odds", "Over.Under", "Favorite.Odds", "Underdog.Odds", "Difference_in_Odds", "Avg.Venue.Attendance", "Attendance_Difference_vs_Avg", "Home.Venue.Average", "Attendance_Difference_vs_Home_Avg", "Pct_Difference_vs_Home_Avg", "Time")
